  ...
  return (
    <div className="relative">
      <button
        ...
        className={`fixed top-4 left-4 z-20 p-2 bg-transparent text-gray-800 rounded-full focus:outline-none ${
      ...
      <div
        className={`fixed h-screen bg-white shadow-lg w-64 space-y-6 py-7 px-2 z-10 transition-transform duration-300 ${
          isSidebarOpen
      ...
      >
        ...
        <button className="items-center flex justify-center w-full"
        onClick={handleHomeClick}>
          <div className="flex items-center space-x-2">
            <img className="w-8 h-8" src={strawberrycake} alt="Logo" />
...
<h2 className="mt-2 text-lg font-semibold underline">
        ...
        <nav className="space-y-2">
          <a
            href="/recipes"
            className="block py-2.5 px-4 rounded transition duration-200 hover:bg-pink-100 flex items-center text-gray-600"
          >
